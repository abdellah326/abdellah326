...
| **Backend / Web** | `Django` • `FastAPI` • `Flask` • `Python` • `PHP` • `C` • `C++` |
| **BI / Viz** | `Power BI` • `Tableau` • `Chart.js` • `Matplotlib` |
| **DevOps** | `Linux` • `Docker` • `Git` • `CI/CD` • `Apache2` |
...
<div align="center">
  <p>
    <a href="mailto:abdellahalaouimhamdi@gmail.com">📫 Email</a> &nbsp;&nbsp;•&nbsp;&nbsp;
    <a href="https://www.linkedin.com/in/abdellah-alaoui-mhamdi-403733338/">🔗 LinkedIn</a> &nbsp;&nbsp;•&nbsp;&nbsp;
